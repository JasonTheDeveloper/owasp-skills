...
By passing malicious data to the `apiUrl` parameter (e.g. `http://google.com:80%5c%5cyahoo.com//`), the function will return a false host and will result in redirecting the user to a malicious website.
