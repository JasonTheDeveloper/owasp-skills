...
A function which is designed to write into a cloud storage, has assigned the following IAM policy, which practically authorizes the function to perform *any* action on *any* bucket in the account:
