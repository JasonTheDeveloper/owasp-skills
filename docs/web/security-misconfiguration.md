...
* A task to review and update the configurations appropriate to all security notes, updates, and patches as part of the patch management process (see [A03 Software Supply Chain Failures](./software-supply-chain-failures.md)). Review cloud storage permissions (e.g., S3 bucket permissions).
